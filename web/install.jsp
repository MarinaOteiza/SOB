    ...
    <body>
        ...
        <%
            ...
            String data[] = new String[]{
                ...
                "INSERT INTO " + schema + ".ARTICLE VALUES (NEXT VALUE FOR ARTICLE_GEN, 'John Doe', 'url',0, '" + java.sql.Date.valueOf(LocalDate.now()) + "', 'Contenido sobre conceptos básicos de programación', 'Introducción a la Programación', 0)"
            };
